...
interface TasksPaginationControlsProps {
  page: number
  pageSize: number
  totalPages: number
  totalItems: number
...
export function TasksPaginationControls({
  page,
  pageSize,
  totalPages,
  totalItems,
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-4 py-3 border-t border-black/20 dark:border-white/20">
