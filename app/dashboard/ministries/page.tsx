...
import { MinistriesPageSkeleton } from '@/components/skeletons'
...
export default function MinistriesPage() {
  ...
  const { ministries, selectedMinistryId, selectedMinistry, isLoading, error, canManage, canManageDetail } = list
