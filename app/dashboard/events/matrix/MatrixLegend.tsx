  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-4 py-3 px-4 border-t bg-white dark:bg-zinc-950 text-xs">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-muted-foreground">{t('itemLedBy')}</span>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-muted-foreground">{t('needsLeader')}</span>
      </div>

      {/* Position assigned */}
      <div className="flex items-center gap-1.5">
        <div className="w-4 h-4 rounded bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800" />
        <span className="text-muted-foreground">{t('positionFilled')}</span>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-muted-foreground">{t('multipleRoles')}</span>
      </div>
    </div>
  )
}
