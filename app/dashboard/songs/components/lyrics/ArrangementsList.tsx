  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        {arrangements.length === 0 ? (
          <p className="text-sm text-muted-foreground py-4 text-center border rounded-lg">
            No arrangements yet. Create one to define the section order.
          </p>
        ) : (
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to delete "${deletingArrangement?.name}"? This cannot be undone.`}
        confirmLabel="Delete"
