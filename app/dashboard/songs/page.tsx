...
import { SongsPageSkeleton } from '@/components/skeletons'
...
export default function SongsPage() {
  ...
  const { filteredSongs, songs, tags, selectedSongId, isLoading, canManage, search, filterTagIds } = list
        ...
        {selectedSong ? (
          <Card>
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-4">
              <div className="flex-1 min-w-0">
                <CardTitle className="text-2xl truncate">{selectedSong.title}</CardTitle>
                {selectedSong.artist && (
