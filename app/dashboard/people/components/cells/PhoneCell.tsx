...
import type { PhoneCellProps } from './types'

export const PhoneCell = memo(function PhoneCell({
  member,
  columnKey,
  getColumnStyle,
  getFrozenClasses,
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  ...
                  disabled={isUpdatingProfile}
                  onClick={() => {
                    onProfileChange(member.id, { phone: value || null })
