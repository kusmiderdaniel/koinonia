-- Update church creation function to handle duplicate slugs with user-friendly errors
...
COMMENT ON FUNCTION create_church_with_owner IS 'Creates a new church and assigns the calling user as owner. Handles duplicate names gracefully with user-friendly error messages.';
